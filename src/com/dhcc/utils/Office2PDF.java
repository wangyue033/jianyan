...
public class Office2PDF 
{
	 ...
	 * @return 处理结果
	 */
	public static void openOffice2Pdf(String inputFilePath, String outputFilePath) 
	{
//		boolean flag = false;
		File inputFile = new File(inputFilePath);
		...
		if ((null != inputFilePath) && (inputFile.exists())) 
		{
			...
			if (office_Formats.contains(getPostfix(inputFilePath))) 
			{
				if (null == outputFilePath) 
				{
					...
					System.out.println(outputFilePath_new);
...
//		return flag;
	...
	{
		Office2PDF.openOffice2Pdf("D:\\myeclipse\\MyEclipse\\apache-tomcat-6.0.36\\webapps\\report\\20170505132055279332-17050422502603643139.xlsx",null);
	}
}
