 ...
 *
 */
public class DeptUser extends BaseBean {
	...
	private String optId,optName,optTime,companyName,jobName,olduserId;
	
	private String sex,certType,certNo,email,telPhone,workDesc,birthDate,photoPath,signPath,mobilePhone;
